...
describe('FoxMemoryAgentsView', () => {
  it('renders model chips', () => {
    render(<FoxMemoryAgentsView foxmemory={mockFoxmemory} prompts={mockPrompts} promptsLoading={false} onSaveExtractionPrompt={noop} onSaveUpdatePrompt={noop} />, { wrapper });
  ...
  it('shows spinner when loading and no prompts', () => {
    render(<FoxMemoryAgentsView foxmemory={mockFoxmemory} prompts={undefined} promptsLoading={true} onSaveExtractionPrompt={noop} onSaveUpdatePrompt={noop} />, { wrapper });
